...
- iTerm2, Ghostty, and Hyper e2e tests are opt-in until those terminals speak tmux -CC against `htm`. They are not part of default `ctest` / `./et-test`. Run them by name:
