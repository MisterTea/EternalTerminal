...
SessionInfo makeInfo(const string& name, const string& host = "example.com",
...
TEST_CASE("SessionStore name validation", "[SessionStore]") {
  ...
  REQUIRE(isValidSessionName("example-20260820-060421"));
...
TEST_CASE("SessionStore save/load round trip", "[SessionStore]") {
  ...
  REQUIRE(loaded->title == "vim - notes");
