...
int main(int argc, char** argv) {
  ...
  srand(time(NULL));
  // Set the port before we fix the random seed so that the port is truly
  // random.
  ...
  cout << win.ws_row << " " << win.ws_col << " " << win.ws_xpixel << " "
       << win.ws_ypixel << endl;
